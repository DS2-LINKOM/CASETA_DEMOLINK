...
public class AccesosSalidasActivity extends mx.linkom.caseta_demolink.Menu {
    ...
    public void RegistrarH (){
        String URL = "https://demo.elkm.mx/plataforma/casetaV2/controlador/dm_access/vst_reg_7.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
