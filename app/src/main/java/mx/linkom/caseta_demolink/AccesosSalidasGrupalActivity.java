...
public class AccesosSalidasGrupalActivity extends mx.linkom.caseta_demolink.Menu {
    Configuracion Conf;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Continuar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_demolink.AccesosMorososActivity.class);
                startActivity(i);
                finish();
            }
        });
    ...
    public void Registrar (){
        ...
        String URL = "https://demo.elkm.mx/plataforma/casetaV2/controlador/dm_access/vst_php7.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
