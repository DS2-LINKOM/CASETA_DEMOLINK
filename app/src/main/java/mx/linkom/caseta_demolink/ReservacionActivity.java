...
public class ReservacionActivity extends mx.linkom.caseta_demolink.Menu {
    ...
    public void obtenerInformacion(final int id_app) {
        String URL = "https://demo.linkom.mx/plataforma/casetaV2/controlador/dm_access/reservacion_individual.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
