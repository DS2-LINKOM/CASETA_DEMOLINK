...
public class  AccesosMorososActivity extends mx.linkom.caseta_demolink.Menu {
    ...
    public void Registrar (){
        ...
        String URL = "https://demo.kap-adm.mx/plataforma/casetaV2/controlador/dm_access/vst_php10.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
