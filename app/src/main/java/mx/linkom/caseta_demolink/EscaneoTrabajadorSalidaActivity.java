...
public class EscaneoTrabajadorSalidaActivity  extends mx.linkom.caseta_demolink.Menu{
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.equals("error")){
                    Conf.setST("Denegado");
                    Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_demolink.AccesosTrabajadorSalidaActivity.class);
                    startActivity(i);
                    finish();
                }else {
