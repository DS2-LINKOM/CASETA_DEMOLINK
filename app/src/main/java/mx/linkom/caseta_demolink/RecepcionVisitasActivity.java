...
private Configuracion Conf;
    ...
    public void entradas() {
        String URL = "https://demo.elkm.mx/plataforma/casetaV2/controlador/dm_access/visitas_recep_1.php";
    ...
    public void salidas() {
        String URL = "https://demo.elkm.mx/plataforma/casetaV2/controlador/dm_access/visitas_recep_2.php";
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
