...
public class RegTrab2Activity extends mx.linkom.caseta_demolink.Menu {
    ...
    public void trabajadores() {
        String URL = "https://demo.kap-adm.mx/plataforma/casetaV2/controlador/dm_access/reg_traba4.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
                ...
                if (entrada != null) {
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            Intent i = new Intent(getApplicationContext(), mx.linkom.caseta_demolink.RegTrab3Activity.class);
                            startActivity(i);
                            finish();
                        }
                    });
