...
public class EntradasSalidasActivity extends  mx.linkom.caseta_demolink.Menu {
                ...
                if (entrada != null) {
                    ...
                    gridList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            if(position==0) {
                                Intent docugen = new Intent(getApplication(), mx.linkom.caseta_demolink.EscaneoVisitaActivity.class);
                                startActivity(docugen);
                                finish();
                            }else if(position==1){
                                Intent docugen = new Intent(getApplication(), mx.linkom.caseta_demolink.EscaneoVisitaSalidaActivity.class);
                                startActivity(docugen);
                                finish();
                            }
            ...
            public void onEntrada(Object entrada, View view) {
                if (entrada != null) {
                    ...
                    gridList4.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                           if(position==0){
                                Intent docugen = new Intent(getApplication(), mx.linkom.caseta_demolink.EscaneoTrabajadorEntradaActivity.class);
                                startActivity(docugen);
                                finish();
                            }else if(position==1){
                                Intent docugen = new Intent(getApplication(), mx.linkom.caseta_demolink.EscaneoTrabajadorSalidaActivity.class);
                                startActivity(docugen);
                                finish();
                            }
                ...
                if (entrada != null) {
                    ...
                    gridList5.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                            ...
                            Intent docugen = new Intent(getApplication(), mx.linkom.caseta_demolink.RecepcionVisitasActivity.class);
                            startActivity(docugen);
                            finish();
