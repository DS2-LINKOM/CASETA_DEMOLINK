...
public class EscaneoVisitaSalidaActivity extends mx.linkom.caseta_demolink.Menu {
    ...
    public void placas() {
        if (placas.getText().toString().equals("")) {
            ...
            String url = "https://demo.linkom.mx/plataforma/casetaV2/controlador/dm_access/vst_php8.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
    ...
    public void placas2(final String id_visita) {
        String url = "https://demo.linkom.mx/plataforma/casetaV2/controlador/dm_access/vst_php9.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
