...
public class IncidenciaActivity  extends mx.linkom.caseta_demolink.Menu{
    ...
    public void Registrar(final int Id){
        ...
        String URL = "https://demo.elkm.mx/plataforma/casetaV2/controlador/dm_access/incidencias.php?bd_name="+Conf.getBd()+"&bd_user="+Conf.getBdUsu()+"&bd_pwd="+Conf.getBdCon();
