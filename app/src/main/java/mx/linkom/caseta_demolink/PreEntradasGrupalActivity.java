...
public class PreEntradasGrupalActivity extends mx.linkom.caseta_demolink.Menu {
...
//ALETORIO3
    ...
    public void Visita() {
        ...
        String URL = "https://demo.elkm.mx/plataforma/casetaV2/controlador/dm_access/vst_gru_2.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
    ...
    public void salidas(final String id_visitante) {
        String URLResidencial = "https://demo.elkm.mx/plataforma/casetaV2/controlador/dm_access/vst_php4.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
        RequestQueue requestQueue = Volley.newRequestQueue(this);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLResidencial, new Response.Listener<String>() {
    ...
    public void Registrar() {
        ...
        if ((Placas.getText().toString().equals("") && !Global.getFotoPlaca()) || (Global.getFotoPlaca() && editTextPlacasPorFoto.getText().toString().equals(""))) {
            ...
            String URL = "https://demo.elkm.mx/plataforma/casetaV2/controlador/dm_access/vst_php5_2.php?bd_name=" + Conf.getBd() + "&bd_user=" + Conf.getBdUsu() + "&bd_pwd=" + Conf.getBdCon();
            RequestQueue requestQueue = Volley.newRequestQueue(this);
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
