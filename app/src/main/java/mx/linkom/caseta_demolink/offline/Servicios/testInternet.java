package mx.linkom.caseta_demolink.offline.Servicios;
                ...
                if (eliminar >= 0){
                    try {
                        ...
                        for (int i = 0; i<array.length(); i++){
                            JSONObject object = array.getJSONObject(i);
                            try {
                                numero = Integer.parseInt(object.getString("numero"));
                            }catch (Exception ex){
                                numero = 0;
                                Log.e("exLugar", ex.toString());
                            }
                        ...
                        System.out.println("lugar"+ex.toString());
                    }
                }
            ...
            public void onResponse(String response) {
                ...
                if (eliminar >= 0){
                    try {
                        ...
                        System.out.println("usuario"+ex.toString());
                    }
                }
